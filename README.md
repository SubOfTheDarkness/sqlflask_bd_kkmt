...
На нижней панели будет надпись "python такой-то", ну либо предложение выбрать версию питона, либо че-то похожее: <br>
![Нижняя панелька](./.github_additions/under_panel.png) <br>
Либо вскод сам предложит выбрать версию питона и создать виртуальное окружение. Если предложит, соглашаемся, если нет - нажимаем на нижней панели на ту самую надпись и выбираем "Create Virual Environment": <br>
![Create Virual Environment](./.github_additions/choice_python.png) <br>
...
```
Потом открываешь в браузере [localhost:5000](https://localhost:5000) (dev) или [localhost:8080](https://localhost:8080) (production)
## Начало
